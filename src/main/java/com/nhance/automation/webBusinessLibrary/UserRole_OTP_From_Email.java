...
public class UserRole_OTP_From_Email {
	            ...
	            for (int i = 0; i < messageCount; i++) {
					...
					try {
						if (message1.getSubject().contains(subjectKeyword) && email.equals(fromEmail)
								&& getText(message1).contains(bodySearchText) && diffMinutes <= 2) {
							...
							if (getText(message1).contains(bodySearchText) == true) {
								...
								bw.close();
								 ...
								 //*********** CHANGE THIS PART ONLY FROM THE EMAIL ****************************//   	
								    	if(lines.get(x).contains("Your temporary password to login is "))
								    	{
								    	 	System.out.println("The line contains : "+lines.get(x));
								    	    OTPCode=lines.get(x).replaceAll("Your temporary password to login is ", "").trim();
	...
	public String OTP_IN_EMail() throws IOException, MessagingException {
		...
		UserRole_OTP_From_Email searcher = new UserRole_OTP_From_Email();
		String subjectKeyword = "Temporary Password for NHANCE NOW";
		String fromEmail = "support@nhancenow.com";
		String bodySearchText = "Your temporary password to login is ";
	...
	//@Test
	public String OTP_IN_AdminEMail() throws IOException, MessagingException {
		String userName = "dhawan@nhancenow.com";
		String password = "Test@123";
		UserRole_OTP_From_Email searcher = new UserRole_OTP_From_Email();
		String subjectKeyword = "Temporary Password for NHANCE NOW";
		String fromEmail = "support@nhancenow.com";
