package com.nhance.automation.customerAdminModulesImplementation;
...
public class ProductManagement extends BaseTest implements BaseFeatureOfNhanceCustomerAdmin {
	...
	void productSpecificSetup()
		...
		cmnElement = new CustomerAdminCommonWebElementInAllPage(getDriver());
		productPage = new ProductManagementPage(getDriver());
